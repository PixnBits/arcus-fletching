	...
	device.description.device.serviceList
		.map(function(xmlServiceDescription){
			...
			return {
				...
				controlUrl : url.resolve(baseUrl, xmlServiceDescription.controlUrl || xmlServiceDescription.controlURL),
				eventSubscriberUrl : url.resolve(baseUrl, xmlServiceDescription.eventSubscriberUrl || xmlServiceDescription.eventSubURL),
				scpdUrl : url.resolve(baseUrl, xmlServiceDescription.scpdUrl || xmlServiceDescription.SCPDURL)
			};
		})
